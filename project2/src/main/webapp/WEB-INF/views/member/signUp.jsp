...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/main-style.css"> <!-- header footer용 -->
    <link rel="stylesheet" href="/resources/css/singUp-style.css"> <!-- 회원가입용 -->
</head>
<body>
    <main>
        ...
        <section class="singUp-content">

            <form action="/member/signUp" method="POST" name="singUp-frm" id="signUp-frm">
